...
class AKBAYProjectCoordinatorController extends Controller
{
    public function ProjectCoordinatorHome()
    {
        ...
        //total benef count
        $akbayBeneficiariesCount = User::whereHas('role', function ($query) {
            $query->where('role_name', 'beneficiary');
        })->whereHas('program', function ($query) use ($userProgramId) {
            $query->where('id', $userProgramId);
        })->count();
        ...
        //total active benef
        $akbayActiveCount = User::whereHas('role', function ($query) {
            $query->where('role_name', 'beneficiary');
        })->whereHas('program', function ($query) use ($userProgramId) {
            $query->where('id', $userProgramId);
        ...
        $akbayInactiveCount = User::whereHas('role', function ($query) {
            $query->where('role_name', 'beneficiary');
        })->whereHas('program', function ($query) use ($userProgramId) {
            $query->where('id', $userProgramId);
        })->whereHas('status', function ($query) {
        ...
        return view('AKBAY_Project_Coordinator.beneficiary', compact('userProfileData', 'akbayBeneficiaries', 'akbayBeneficiariesCount', 'akbayActiveCount', 'akbayInactiveCount', 'programName', 'updates', 'project', 'benefSchedules', 'programLogo'));
    } // End Method
    ...
    public function ProjCoordinatorAnnouncement()
    {
       ...
       $announcement = announcement::where(function ($query) use ($programName, $status) {
        ...
        return view('AKBAY_Project_Coordinator.announcement', compact('announcement','programName', 'roleName', 'programEmail'));
    } // End Method
    ...
    public function ProjectCoordinatorAnnouncementEdit($id)
    {
        ...
        return view('AKBAY_Project_Coordinator.announcement', compact('announcement'));
    } // End Method
    ...
    public function ProjCoordinatorEvent()
    {
       ...
       $programName = trim(implode(' ', Program::where('id', $programId)->pluck('program_name')->toArray()));
        ...
        return view('AKBAY_Project_Coordinator.event', compact('event','programName', 'roleName'));
    } // End Method
    ...
    public function ProjCoordinatorUpdateProject(Request $request)
{
    ...
    public function ProjCoordinatorProgress()
    {
        ...
        $totalActiveAndInactiveCount = [$akbayActiveCount, $akbayInactiveCount];
    ...
    public function ProjCoordinatorProgressAdd(Request $request)
    {
        ...
        return redirect()->route('akbayprojectcoordinator.progress');
    } // End Method
    ...
    public function ProjCoordinatorViewProfile()
    {
        ...
        return view('AKBAY_Project_Coordinator.profile', compact('userProfileData'));
    } // End Method
    ...
    public function ProjCoordinatorViewChangePassword()
    {
        ...
        return view('AKBAY_Project_Coordinator.pass', compact('userProfileData'));
    } // End Method
    ...
    public function ProjCoordinatorRegisterView()
    {
        ...
        return view('AKBAY_Project_Coordinator.registerView', compact('users', 'roles', 'statuses'));
    } // End Method
