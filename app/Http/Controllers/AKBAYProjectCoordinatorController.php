...
class AKBAYProjectCoordinatorController extends Controller
{
    public function ProjectCoordinatorHome()
    {
        ...
        return view('AKBAY_Project_Coordinator.beneficiary', compact('userProfileData'));
    } // End Method
    ...
    public function ProjCoordinatorAnnouncement()
    {
        ...
        return view('AKBAY_Project_Coordinator.announcement', ['announcement'=>$announcement]);
    } // End Method
    ...
    public function ProjCoordinatorEvent()
    {
        ...
        return view('AKBAY_Project_Coordinator.event', ['event'=>$event]);
    } // End Method
    ...
    public function ProjCoordinatorInquiry()
    {
        ...
        return view('AKBAY_Project_Coordinator.inquiry', ['progress'=>$inquiry]);
    } // End Method
    public function ProjCoordinatorProgress()
    {
        $progress = progress::all();

        return view('AKBAY_Project_Coordinator.progress', ['progress'=>$progress]);
    } // End Method
}
