...
class AKBAYProjectCoordinatorController extends Controller
{
    public function ProjectCoordinatorHome()
    {
        ...
        return view('AKBAY_Project_Coordinator.beneficiary', compact('userProfileData', 'akbayBeneficiaries', 'akbayBeneficiariesCount', 'akbayActiveCount', 'akbayInactiveCount', 'programName', 'updates', 'project', 'benefSchedules'));
    } // End Method
