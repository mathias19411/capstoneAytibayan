                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('update.announcementcoordinatoragripinay') }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                            <div class="row">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                        <form method="POST" action="{{ route('delete.announcementcoordinatoragripinay') }}">
                                            @csrf
                                            @method('DELETE')
                                        <div class="row">
...
<div class="modal fade" id="modal_announcement" tabindex="-1" data-backdrop="false" data-bs-backdrop="static"  data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                <form action="{{ route('store.announcementcoordinatoragripinay') }}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
