                    ...
                    <tbody>
                        @foreach ($agripinayBeneficiaries as $agripinayBeneficiary)
                            ...
                            <div class="modal fade" id="view_beneficiary_updates{{ $agripinayBeneficiary->id }}" tabindex="-1"  data-backdrop="false" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        @if ($agripinayBeneficiary->email === $schedule->recipient_email)
                                        <!--VIEW SCHEDULE-->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="schedule-container">
                                                            ...
                                                            @if ($agripinayBeneficiary->email === $schedules->recipient_email)
                                        ...
                                        @endforeach              
                                        @if(!empty($schedule))
                                        @if(!empty($agripinayBeneficiary->email === $schedule->recipient_email))
                                        <button class="add-project_modal" data-tooltip="View" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#view-schedule-modal{{ $agripinayBeneficiary->id }}">View Schedule</button>
                                        @endif
                                        @endif
                                        <button class="add-project_modal" data-tooltip="View" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#add-schedule-modal{{ $agripinayBeneficiary->id }}">Add Schedule</button>
                                        <form action="{{ route('agripinayread.update') }}" method="post">
                                            @csrf
                                            @method('patch')
                                        <div class="modal-footer">
                            ...
                            <tr>
                                ...
                                <td>{{ substr($agripinayBeneficiary->phone, 2) }}</td>

                                <td>N/A</td>
                                <td class="no-print">
                                <input type="hidden" name="benef_email" value="{{ $agripinayBeneficiary->email }}" > 

                                <button class="tooltip-button" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view_beneficiary_updates{{ $agripinayBeneficiary->id }}">
