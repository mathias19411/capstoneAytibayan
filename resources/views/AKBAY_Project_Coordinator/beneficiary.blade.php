                    ...
                    <tbody>
                        @foreach ($akbayBeneficiaries as $akbayBeneficiary)
                            ...
                            <tr>
                                ...
                                <button class="tooltip-button" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view_beneficiary_updates{{ $akbayBeneficiary->id }}"><i class="fa-solid fa-eye fa-2xs"></i></button>
                                ...
                                <td>{{ $akbayBeneficiary->status->status_name }}</td>
                            </tr>
                        </div>
                        @endforeach
                    </tbody>
