            ...
            <table class="table">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <span class="h4 ms-3">{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}</span>
                                    <br><br>
                                        <form action="{{ route('akbayprojectcoordinator.registerEditUser') }}" enctype="multipart/form-data" method="post">
                                            @csrf
                                        <div class="row">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <form action="{{ route('akbayprojectCoordinator.BlacklistUser', $user->id) }}" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
                                    <div class="col-md-12 mb-4">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- <button class="tooltip-button" data-tooltip="Blacklist"><a href="{{ route('akbayprojectCoordinator.BlacklistUser', $user->id) }}" id="blacklist"><i class="fa-solid fa-ban fa-2xs"></i></a></button> --}}
