    ...
    <div class="container">
                <table class="table">
                    ...
                    @foreach($inquiry->reverse() as $inquiry)
                        <!--MODAL VIEW-->
                        <form action="{{ route('akbaymark.AsRead' ) }}" method="post">
                            @csrf
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                        <form action="{{ route('reply.inquirycoordinatorakbay') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                            <input type="hidden" name="inquiry_id" value="{{ $inquiry->id }}">
                                                <div class="col-md-6 mb-4">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                        <form method="POST" action="{{ route('delete.inquirycoordinatorakbay') }}">
                                            @csrf
                                            @method('DELETE')
                                            <div class="row">
                                            <input type="hidden" name="inquiry_id" value="{{ $inquiry->id }}">
                        ...
                        <td class="column">{{ $inquiry->created_at->format('Y-m-d h:i A')  }}</td>
                        <td class="column">
