...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Assets/css/akbay-print.css') }}" media="print">
...
<body class="announcement_events_inquiry">
    ...
    <script>
        ...
        function showUpdateRepaymentPopup(beneficiaryId) {
            const popup = document.getElementById('update-repayment-popup-' + beneficiaryId);
            popup.style.display = "block";
        }

        // Function to hide the repayment status popup
        function hideUpdateRepaymentPopup(beneficiaryId) {
            const popup = document.getElementById('update-repayment-popup-' + beneficiaryId);
            popup.style.display = "none";
        }

        function sendRepaymentNotification(userId) {
    // Make an AJAX request
    fetch(`/AKBAY_ProjectCoordinator/ProgressLoanReminder/${userId}`, {
        method: 'POST',
        headers: {
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function exportTable() {
            ...
            link.download = `AKBAY (${dateTime}).csv`;
            link.click();
        }
    });
</script>
