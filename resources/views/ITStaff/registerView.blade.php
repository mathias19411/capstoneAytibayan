...
@section('content')
        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($users as $user)
                    {{-- Modal View --}}
                    <div class="modal fade" id="itStaffRegister{{ $user->id }}" tabindex="-1" data-backdrop="false"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <h5>Address:</h5>
                                            <p id="modal-message">{{ $user->barangay }}, {{ $user->city }},
                                                {{ $user->province }} {{ $user->zip }}</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!--Update User Status-->
                    <div class="modal fade" id="modal_edit{{ $user->id }}" tabindex="-1" data-backdrop="false"
                        aria-labelledby="event_modal" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <form action="{{ route('itstaff.BlacklistUser', $user->id) }}" enctype="multipart/form-data"
                                        method="post">
                                        @csrf
                                        <div class="col-md-12 mb-4">
                                            <div class="form-outline">
    ...
    <tr>
        ...
        <td>
            ...
            <button class="tooltip-button" data-tooltip="Edit" class="add-modal" data-bs-toggle="modal"
                data-bs-target="#modal_edit{{ $user->id }}"><i class="fa-solid fa-pen-to-square fa-2xs"></i></button>
            {{-- <button class="tooltip-button" data-tooltip="Blacklist"><a href="{{ route('itstaff.BlacklistUser', $user->id) }}" id="blacklist"><i class="fa-solid fa-ban fa-2xs"></i></a></button> --}}
    ...
    <script>
        ...
        remarksTextArea.style.height = remarksTextArea.scrollHeight + 'px';
        }

        const debouncedUpdateTextAreaHeight = debounce(updateTextAreaHeight, 100); // Debounce by 100 milliseconds

        remarksTextArea.addEventListener('input', debouncedUpdateTextAreaHeight);
    </script>
