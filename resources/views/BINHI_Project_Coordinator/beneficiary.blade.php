...
@include('BINHI_Project_Coordinator.Body.sidebarproj')
        ...
        <div class="boxes1">
            <div class="box box-5">
                <h1>Beneficiaries</h1>
                <p>{{ $binhiBeneficiariesCount }}</p>
            </div>
            <div class="box box-5 ">
                <h1>Active</h1>
                <p>{{ $binhiActiveCount }}</p>
            </div>
            <div class="box box-6">
                <h1>Inactive</h1>
                <p>{{ $binhiInactiveCount }}</p>
            </div>
        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($binhiBeneficiaries as $binhiBeneficiary)
                            ...
                            <!--view_beneficiaries-->
                            <div class="modal fade" id="view_beneficiary_updates{{ $binhiBeneficiary->id }}" tabindex="-1"  data-backdrop="false" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modal-title">Beneficiary:  {{ $binhiBeneficiary->first_name }} {{ $binhiBeneficiary->middle_name }} {{ $binhiBeneficiary->last_name }}</h5>
                                        ...
                                        <div class="sched-header">Updates</div>
                                            ...
                                            @if ($binhiBeneficiary->email === $update->email)
                                            <div class="box">
                                        ...
                                        @if ($binhiBeneficiary->email === $schedule->recipient_email)
                                        <!--VIEW SCHEDULE-->
                                        <div class="modal fade" id="view-schedule-modal{{ $binhiBeneficiary->id }}" tabindex="-1" data-backdrop="false" data-bs-backdrop="static"  data-bs-backdrop="static" aria-labelledby="event_modal" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="schedule-container">
                                                            ...
                                                            @if ($binhiBeneficiary->email === $schedules->recipient_email)
                                        ...
                                        @endforeach              
                                        @if(!empty($schedule))
                                        @if(!empty($binhiBeneficiary->email === $schedule->recipient_email))
                                        <button class="add-project_modal" data-tooltip="View" class="add-modal" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#view-schedule-modal{{ $binhiBeneficiary->id }}">View Schedule</button>
                                        @else
                                        ...
                                        <form action="{{ route('binhiread.update') }}" method="post">
                                            @csrf
                                            @method('patch')
                                        <div class="modal-footer">
                                            <input type="hidden" name="benef_email" value="{{ $binhiBeneficiary->email }}">
                                            ...
                                            <div class="col">
                                                <div class="col-md-12">
                                                    <img class="ht-50 wd-50 rounded-circle"
                                                        src="{{ !empty($binhiBeneficiary->photo) ? url('Uploads/Beneficiary_Images/' . $binhiBeneficiary->photo) : url('Uploads/user-icon-png-person-user-profile-icon-20.png') }}"
                                                        alt="profile">
                                                </div>
                                                <br>
                                                <span class="h4 ms-3">{{ $binhiBeneficiary->first_name }} {{ $binhiBeneficiary->middle_name }} {{ $binhiBeneficiary->last_name }}</span>
                                                <br><br>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Email:</h5>
                                                <p id="modal-recipient">{{ $binhiBeneficiary->email }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Program:</h5>
                                                <p id="modal-recipient">{{ $binhiBeneficiary->program->program_name }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Role:</h5>
                                                <p id="modal-message">{{ $binhiBeneficiary->role->role_name }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Contact Number:</h5>
                                                <p id="modal-message">{{ $binhiBeneficiary->phone }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Address:</h5>
                                                <p id="modal-message">{{ $binhiBeneficiary->barangay }}, {{ $binhiBeneficiary->city }}, {{ $binhiBeneficiary->province }} {{ $binhiBeneficiary->zip }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                            ...
                            <tr>
                                ...
                                <td>{{ $binhiBeneficiary->first_name }} {{ $binhiBeneficiary->middle_name }}
                                    {{ $binhiBeneficiary->last_name }}</td>
                                <td>{{ $binhiBeneficiary->barangay }}</td>
                                <td>{{ $binhiBeneficiary->city }}</td>
                                <td>{{ $binhiBeneficiary->province }}</td>
                                
                                <td>{{ $binhiBeneficiary->email }}</td>
                                <td>{{ substr($binhiBeneficiary->phone, 2) }}</td>

                                <td>N/A</td>
                                <td class="no-print">
                                <input type="hidden" name="benef_email" value="{{ $binhiBeneficiary->email }}" > 
                                <button class="tooltip-button" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view_beneficiary_updates{{ $binhiBeneficiary->id }}"><i class="fa-solid fa-eye fa-2xs">
