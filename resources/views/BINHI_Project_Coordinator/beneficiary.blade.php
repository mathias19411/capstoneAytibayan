                    ...
                    <tbody>
                        @foreach ($binhiBeneficiaries as $binhiBeneficiary)
                            ...
                            <tr>
                                ...
                                <button class="tooltip-button" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view_beneficiary_updates{{ $binhiBeneficiary->id }}"><i class="fa-solid fa-eye fa-2xs"></i></button>
