                ...
                <table class="table">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col profile">
                                            ...
                                            <br>
                                            <span class="h4 ms-3 name">{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}</span>
                                            <br><br>
                                        </div>
                                        <div class="col-md-12">
                                            <h5>Email:</h5>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <br><br>
                                            <form action="{{ route('binhiprojectcoordinator.registerEditUser') }}" enctype="multipart/form-data" method="post">
                                                @csrf
                                            <div class="row">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <form action="{{ route('binhiprojectcoordinator.BlacklistUser', $user->id) }}" enctype="multipart/form-data"
                                        method="post">
                                        @csrf
                                        <div class="col-md-12 mb-4">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <button class="tooltip-button" data-tooltip="Blacklist"><a href="{{ route('binhiprojectcoordinator.BlacklistUser', $user->id) }}" id="blacklist"><i class="fa-solid fa-ban fa-2xs"></i></a></button> --}}
