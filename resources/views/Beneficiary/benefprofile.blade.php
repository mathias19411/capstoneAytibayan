            ...
            <div class="row">
                    ...
                    <div class="card card-profile shadow">
                        ...
                        <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="text-center">
                                ...
                                <h3>
                                    {{ substr($userProfileData->phone, 2) }}
                                    <span class="font-weight-light"></span>
                                </h3>
                                <div class="h5 font-weight-300">
                ...
                <div class="col-xl-8 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('beneficiary.editprofile') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-container">
                                                <img id="image-preview"
                                                    src="{{ !empty($userProfileData->photo) ? url('Uploads/Beneficiary_Images/' . $userProfileData->photo) : url('Uploads/user-icon-png-person-user-profile-icon-20.png') }}"
