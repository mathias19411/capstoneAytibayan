...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Assets/css/lead-print.css') }}" media="print">
...
<body class="announcement_events_inquiry">
    ...
    fetch(`/LEAD_ProjectCoordinator/ProgressLoanReminder/${userId}`, {
        method: 'POST',
        headers: {
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function exportTable() {
            ...
            link.download = `LEAD (${dateTime}).csv`;
            link.click();
        }
    });
</script>
