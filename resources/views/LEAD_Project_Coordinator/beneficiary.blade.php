  ...
  <div class="table-header-left">
    ...
    <div class="table-header-right">
        ...
        <div class="print-header">
            ...
            <h4>AbakaBuhayan Project, "LEAD MO, PISO MO" CASH INCENTIVE SCHEME</h4>
            </div>
                <table class="table">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                        @foreach ($leadBeneficiaries as $leadBeneficiary)
                            ...
                            <!--view_beneficiaries-->
                            <div class="modal fade" id="view_beneficiary_updates{{ $leadBeneficiary->id }}" tabindex="-1"  data-backdrop="false" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modal-title">Beneficiary:  {{ $leadBeneficiary->first_name }} {{ $leadBeneficiary->middle_name }} {{ $leadBeneficiary->last_name }}</h5>
                                        ...
                                        <div class="sched-header">Updates</div>
                                            ...
                                            @if ($leadBeneficiary->email === $update->email)
                                            <div class="box">
                                        ...
                                        @if ($leadBeneficiary->email === $schedule->recipient_email)
                                        <!--VIEW SCHEDULE-->
                                        <div class="modal fade" id="view-schedule-modal{{ $leadBeneficiary->id }}" tabindex="-1" data-backdrop="false" data-bs-backdrop="static"  data-bs-backdrop="static" aria-labelledby="event_modal" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="schedule-container">
                                                            ...
                                                            @if ($leadBeneficiary->email === $schedules->recipient_email)
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                        <form method="POST" action="{{ route('leaddelete.schedule') }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="row">
                                                            <input type="hidden" name="schedule_id" value="{{ $schedule->id }}">
                                        ...
                                        @endforeach              
                                        @if(!empty($schedule))
                                        @if(!empty($leadBeneficiary->email === $schedule->recipient_email))
                                        <button class="add-project_modal" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view-schedule-modal{{ $leadBeneficiary->id }}">View Schedule</button>
                                        @else
                                        ...
                                        @endif
                                        @endif
                                        <button class="add-project_modal" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#add-schedule-modal{{ $leadBeneficiary->id }}">Add Schedule</button>
                                        <form action="{{ route('leadread.update') }}" method="post">
                                            @csrf
                                            @method('patch')
                                        <div class="modal-footer">
                                            <input type="hidden" name="benef_email" value="{{ $leadBeneficiary->email }}">
                            ...
                            <!-- Add Schedule Modal -->
                            <div class="modal fade" id="add-schedule-modal{{ $leadBeneficiary->id }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form id="add-schedule-form" action="{{ route('leadadd.schedule') }}" method="post">
                                            @csrf
                                        <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="schedule-description" class="form-label">Description:</label>
                                            ...
                                            <div class="col">
                                                <div class="col-md-12">
                                                    <img class="ht-50 wd-50 rounded-circle"
                                                        src="{{ !empty($leadBeneficiary->photo) ? url('Uploads/Beneficiary_Images/' . $leadBeneficiary->photo) : url('Uploads/user-icon-png-person-user-profile-icon-20.png') }}"
                                                        alt="profile">
                                                </div>
                                                <br>
                                                <span class="h4 ms-3">{{ $leadBeneficiary->first_name }} {{ $leadBeneficiary->middle_name }} {{ $leadBeneficiary->last_name }}</span>
                                                <br><br>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Email:</h5>
                                                <p id="modal-recipient">{{ $leadBeneficiary->email }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Program:</h5>
                                                <p id="modal-recipient">{{ $leadBeneficiary->program->program_name }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Role:</h5>
                                                <p id="modal-message">{{ $leadBeneficiary->role->role_name }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Contact Number:</h5>
                                                <p id="modal-message">{{ $leadBeneficiary->phone }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h5>Address:</h5>
                                                <p id="modal-message">{{ $leadBeneficiary->barangay }}, {{ $leadBeneficiary->city }}, {{ $leadBeneficiary->province }} {{ $leadBeneficiary->zip }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                            ...
                            <tr>
                                ...
                                <td>{{ $leadBeneficiary->barangay }} {{ $leadBeneficiary->city }}</td>
                                ...
                                <td class="no-print">
                                <input type="hidden" name="benef_email" value="{{ $leadBeneficiary->email }}" > 
                                <button class="tooltip-button" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view_beneficiary_updates{{ $leadBeneficiary->id }}"><i class="fa-solid fa-eye fa-2xs">
                                ...
                                <td<td style="color: {{ $leadBeneficiary->status->status_name === 'Active' ? 'green' : 'red' }}; ; padding: 5px; border-radius: 5px;">
                                    {{ $leadBeneficiary->status->status_name }}</td>
                            </tr>
                        </div>
                        @endforeach
                    </tbody>
                        ...
                        <div class="modal fade" id="modal_editproject{{ $projects->id }}" tabindex="-1" data-backdrop="false" data-bs-backdrop="static"  data-bs-backdrop="static" aria-labelledby="event_modal" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('leadedit.project') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PATCH')
                                        <div class="modal-body">
                                            <div class="project-info-edit">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                        <form method="POST" action="{{ route('leaddelete.project') }}">
                                            @csrf
                                            @method('DELETE')
                                            <div class="row">
                                            <input type="hidden" name="project_id" value="{{ $projects->id }}">
                        ...
                        <div class="modal fade" id="modal_addproject" tabindex="-1" data-backdrop="static" aria-labelledby="event_modal" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5)">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('leadadd.project') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
