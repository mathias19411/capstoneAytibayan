                    ...
                    <tbody>
                        @foreach ($leadBeneficiaries as $leadBeneficiary)
                            ...
                            <tr>
                                ...
                                <button class="tooltip-button" data-tooltip="View" class="add-modal" data-bs-toggle="modal" data-bs-target="#view_beneficiary_updates{{ $leadBeneficiary->id }}"><i class="fa-solid fa-eye fa-2xs"></i></button>
