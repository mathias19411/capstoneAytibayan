        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        <button class="tooltip-button" data-tooltip="Restore"><a href="{{ route('leadprojectCoordinator.RestoreUser', $user->id) }}" id="restore"><i class="fa-solid fa-suitcase-medical fa-2xs"></i></a></button>
                    </td>
