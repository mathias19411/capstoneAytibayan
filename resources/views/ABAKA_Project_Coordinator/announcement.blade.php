                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                    <form action="{{ route('update.announcementcoordinatorabaka') }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                            <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                <form action="{{ route('store.announcementcoordinatorabaka') }}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
