                ...
                <div class="modal fade" id="ModalBlacklist{{ $user->id }}" tabindex="-1" data-backdrop="false"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <form action="{{ route('abakaprojectcoordinator.BlacklistUser', $user->id) }}" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
                                    <div class="col-md-12 mb-4">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <button class="tooltip-button" data-tooltip="Blacklist"><a href="{{ route('abakaprojectcoordinator.BlacklistUser', $user->id) }}" id="blacklist"><i class="fa-solid fa-ban fa-2xs"></i></a></button> --}}
