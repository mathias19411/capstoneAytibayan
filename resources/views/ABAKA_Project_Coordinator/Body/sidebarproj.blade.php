...
//Access the specific row data of the user's id
    ...
    <li class="{{ Route::currentRouteName() == 'abakaprojectcoordinator.announcement' ? 'active' : '' }}">
            ...
            <li class="{{ Route::currentRouteName() == 'abakaprojectcoordinator.BlacklistView' ? 'active' : '' }}">
                <a href="{{ route('abakaprojectcoordinator.BlacklistView') }}">
                    <i class="uil uil-x"></i>
        ...
        <ul class="logout-mode">
            ...
            <li><a href="{{ route('abakaprojectCoordinator.logout') }}">
    ...
    <div class="top">
        ...
        <div class="profile-dropdown">
            ...
            <ul class="sub-menus">
                ...
                <li>
                    <a href="{{ route('abakaprojectcoordinator.viewprofile') }}">
                        <i class="uil uil-user"></i> Profile
                    </a>
                </li>
                <li><a href="{{ route('abakaprojectcoordinator.viewchangepassword') }}"><i class="uil uil-lock"></i> Change Password</a></li>
            </ul>
        </div>
